function scrollpal(SqrSiz,Dir,Spd,Den,GMode)
% Sample script scrollpal v1.29
%
% Creates a smoothly scrolling chessboard display of black
% and white squares.  The display is in palette mode.
%
% Usage:-   scrollpal(SqrSiz,Dir,Spd,Den,GMode)
%
...
%
% Default:- scrollpal(8,45,1,0.5,1)
%
...
cgnewpal
%*************************************************************
% Make the sprite, initialising it to palette index 0 (black)
% and set the drawing colour to palette index 1 (white).
%
cgmakesprite(1,ScrWid,ScrHgh,0)
cgpencol(1)
%*************************************************************
% Draw the sprite.
%
...
%   
   ...
   cgpencol(1)
    ...
    str = sprintf('scrollpal v1.29 P:%s Tim:%02d:%02d:%02d Frm:%d Av:%-.2fHz Drp:%d',...
        cogstd('spriority'),...
