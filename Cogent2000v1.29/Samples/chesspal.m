function chesspal(SqrWid,SqrHgh,Frm,GMode)
% Sample script chesspal v1.29
%
% Creates a chessboard display of black and white squares
% which flashes at a constant rate, swapping black and 
% white.  The display is in palette mode.
%
% Usage:-   chesspal(SqrWid,SqrHgh,Frm,GMode)
%
...
cgcoltab(2,0,0,0)	% palette index 2 r,g,b = 0,0,0 = black
cgcoltab(3,1,1,1)	% palette index 3 r,g,b = 1,1,1 = white
...
%
% Sprite 1 is initialised to palette index 2 (black)
% Sprite 2 is initialised to palette index 3 (white)
%
cgmakesprite(1,ScrWid,ScrHgh,2)
cgmakesprite(2,ScrWid,ScrHgh,3)
%*************************************************************
...
%   
   ...
   cgpencol(1)
    ...
    str = sprintf('chesspal v1.29 P:%s Tim:%02d:%02d:%02d Frm:%d Av:%-.2fHz Drp:%d',...
        cogstd('spriority'),...
